...
//                return get10();
    ...
    private static LevelData get5() {
        ...
        correctMoves.add(new Pair<>(new BoardCell(2, 5), new BoardCell(3, 4)));
        correctMoves.add(new Pair<>(new BoardCell(6, 7), new BoardCell(2, 3)));
        return new LevelData(levelNumber, pieces, correctMoves);
    }
    ...
    private static LevelData get7() {
        ...
        pieces.add(new CheckersPiece(new BoardCell(6, 3), Player.WHITE, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(6, 5), Player.WHITE, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(6, 7), Player.WHITE, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(0, 3), Player.BLACK, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(1, 4), Player.BLACK, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(3, 0), Player.BLACK, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(4, 7), Player.BLACK, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(6, 1), Player.BLACK, PieceRank.PAWN));
        ArrayList<Pair<BoardCell, BoardCell>> correctMoves = new ArrayList<>();
    ...
    private static LevelData get8() {
        ...
        pieces.add(new CheckersPiece(new BoardCell(3, 0), Player.BLACK, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(3, 2), Player.BLACK, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(4, 5), Player.BLACK, PieceRank.PAWN));
        ArrayList<Pair<BoardCell, BoardCell>> correctMoves = new ArrayList<>();
        correctMoves.add(new Pair<>(new BoardCell(6, 5), new BoardCell(5, 6)));
        correctMoves.add(new Pair<>(new BoardCell(3, 0), new BoardCell(5, 2)));
        correctMoves.add(new Pair<>(new BoardCell(5, 6), new BoardCell(3, 4)));
        correctMoves.add(new Pair<>(new BoardCell(2, 3), new BoardCell(4, 5)));
        correctMoves.add(new Pair<>(new BoardCell(6, 3), new BoardCell(4, 1)));
        correctMoves.add(new Pair<>(new BoardCell(4, 1), new BoardCell(2, 3)));
        correctMoves.add(new Pair<>(new BoardCell(2, 3), new BoardCell(0, 1)));
        return new LevelData(levelNumber, pieces, correctMoves);
    }
    ...
    private static LevelData get9() {
        ...
        pieces.add(new CheckersPiece(new BoardCell(3, 0), Player.WHITE, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(3, 6), Player.WHITE, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(4, 5), Player.WHITE, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(4, 7), Player.WHITE, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(5, 2), Player.WHITE, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(5, 4), Player.WHITE, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(6, 3), Player.WHITE, PieceRank.PAWN));
        pieces.add(new CheckersPiece(new BoardCell(7, 2), Player.WHITE, PieceRank.PAWN));
        ...
        pieces.add(new CheckersPiece(new BoardCell(2, 7), Player.BLACK, PieceRank.PAWN));
        ArrayList<Pair<BoardCell, BoardCell>> correctMoves = new ArrayList<>();
        correctMoves.add(new Pair<>(new BoardCell(4, 5), new BoardCell(3, 4)));
        correctMoves.add(new Pair<>(new BoardCell(1, 0), new BoardCell(3, 2)));
        correctMoves.add(new Pair<>(new BoardCell(3, 6), new BoardCell(2, 5)));
        correctMoves.add(new Pair<>(new BoardCell(2, 3), new BoardCell(4, 5)));
        correctMoves.add(new Pair<>(new BoardCell(5, 4), new BoardCell(3, 6)));
        correctMoves.add(new Pair<>(new BoardCell(1, 6), new BoardCell(3, 4)));
        correctMoves.add(new Pair<>(new BoardCell(7, 6), new BoardCell(6, 7)));
        correctMoves.add(new Pair<>(new BoardCell(2, 7), new BoardCell(4, 5)));
        correctMoves.add(new Pair<>(new BoardCell(5, 2), new BoardCell(4, 3)));
        correctMoves.add(new Pair<>(new BoardCell(3, 2), new BoardCell(5, 4)));
        correctMoves.add(new Pair<>(new BoardCell(4, 7), new BoardCell(3, 6)));
        correctMoves.add(new Pair<>(new BoardCell(4, 5), new BoardCell(2, 7)));
        correctMoves.add(new Pair<>(new BoardCell(6, 3), new BoardCell(4, 5)));
        correctMoves.add(new Pair<>(new BoardCell(4, 5), new BoardCell(2, 3)));
        correctMoves.add(new Pair<>(new BoardCell(2, 3), new BoardCell(0, 1)));
        return new LevelData(levelNumber, pieces, correctMoves);
    }
